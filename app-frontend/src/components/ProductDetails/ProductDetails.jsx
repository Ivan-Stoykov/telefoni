    ...
    <div className="container-fluid px-4 px-xl-5 py-5 bg-white">
      {phone && (
        <>
          ...
          {/* <-- ТУК ПРИКЛЮЧВА ГОРНАТА ЧАСТ (Много е важно!) */}
          {/* 2. ТАБОВЕ (Навигация) */}
            ...
            {activeTab === "description" && (
              <div className="row text-muted small lh-lg">
                ...
                <div className="col-md-3">
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-2">
                      <span className="text-dark fw-semibold">Courier:</span> 2
                      - 4 days, free shipping
                    </li>
                    <li className="mb-2">
                    ...
                    <li className="mb-2">
                      <span className="text-dark fw-semibold">UPS Ground:</span>{" "}
                      4 - 6 days, $29.00
                    </li>
                  </ul>
                </div>
              ...
              <div>
                  ...
                  <div className="col-md-7 ps-lg-5 small fw-bold text-secondary">
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div style={{ width: "80px" }}>
                        63% <span className="text-muted fw-normal">(94k)</span>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div style={{ width: "80px" }}>
                        24% <span className="text-muted fw-normal">(6k)</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-bottom pb-4 mb-4">
                  ...
                  <p className="text-muted small mb-0 lh-lg">
                    ...
                    Vestibulum ullamcorper ut lectus nec tincidunt.
                  </p>
                </div>
              </div>
            )}
