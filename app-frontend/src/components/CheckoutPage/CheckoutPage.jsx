...
const CheckoutPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      console.log("Order Data:", { items: cartItems, shippingDetails: formData });
      alert("Към плащане... (тук ще извикаме бекенда за създаване на поръчката)");
    }
  };
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="row g-5">
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 form-group">
                    ...
                    <select 
                      ...
                      onChange={handleChange}
                    >
                      <option value="Speedy - free delivery">Speedy - free delivery</option>
            ...
            <div className="col-lg-5 col-xl-4">
              <div className="checkout-card">
                <h4 className="checkout-title" style={{ fontSize: '1.25rem', marginBottom: '40px' }}>
                  Order Summary
                </h4>
                  ...
                  {cartItems.map((item) => (
                    <div className="summary-item-row" key={item.id}>
                      ...
                      <span className="fw-medium text-dark text-nowrap">
                        €{((item.price || item.phone_spec?.price || 0) * item.quantity).toFixed(2)}
                      </span>
                    </div>
                  ))}
                </div>
